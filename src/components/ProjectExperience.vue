<template>
  <v-container fluid class="fill-height">
    ...
    <v-carousel
        ...
        class="fill-height"
    >
      <v-carousel-item v-for="(project,index) in projectExperience" :key="index">
        <v-row class="fill-height" justify="center" dense>
          <v-col md="6" sm="9" cols="12">
            <v-card class="mx-3">
              ...
              <v-card-actions>
                <v-btn color="#1876d1" class="white--text" :href="project.githubSrc">
                  <v-icon left>mdi-github</v-icon>
                  仓库链接
                </v-btn>
                <v-btn text color="#1876d1" :href="project.readmeSrc">详情</v-btn>
              </v-card-actions>
            </v-card>
          </v-col>
          <v-col sm="3" class="d-none d-md-block">
            <v-card class="mb-3">
              <v-card-title>Java</v-card-title>
              <v-card-subtitle>xxx技术点</v-card-subtitle>
            </v-card>
            <v-card>
              <v-card-title>Java</v-card-title>
              <v-card-subtitle>xxx技术点</v-card-subtitle>
...
<script>
import projectExperience from "@/util/projectExperience";
